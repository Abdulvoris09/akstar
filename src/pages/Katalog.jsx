...
const Katalog = ({ addCart, addLike, deletCart, e }) => {
    ...
    return (
        <li className='sm:ml-auto sm:w-[300px] mt-5 md:w-full rounded-2xl p-2'>
            <button className={`${like === false ? 'absolute md:ml-[80px] ml-[200px] gap-[200px] rounded-3xl text-white w-5 text-center items-center' : 'bg-red-500 p-[2px] rounded-3xl absolute items-center ml-[200px] md:ml-[80px] gap-[225px]'}`} onClick={() => toggle(e.id)}>
            ...
            <img className="rounded-[15px] mt-[30px] h-[200px] ml-2 sm:rounded-[15px]" src={e.img} alt="" />
            ...
            <p className="text-blue-800 text-lg font-extrabold font-['Raleway']">{e.puli} so'm</p>
